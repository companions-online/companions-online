 ...
 *
 * The layering intent (low → high): grass underlies everything, dirt patches
 * over grass, sand beaches override dirt/grass, rock pokes over soil, rivers
 * and water flood onto shore.
 */
...
// Re-export Terrain so callers in client-web can work without reaching into
