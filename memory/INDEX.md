...
- [harness/variants](harness/variants.md) — compact/baseline/truncated: state shapes, prompt-build differences, when to use each, why no `continue` after tool results
